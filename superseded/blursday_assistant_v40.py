...
independent_vars3 = independent_vars1 + " + Sex:Stringency_Index + Sex:Reported_Loneliness + Sex:Felt_Loneliness + Sex:Subjective_Confinement + Sex:ConfDuration"
independent_vars1 += f" + {session_fixed_effects}"
independent_vars2 += f" + {session_fixed_effects}"
independent_vars3 += f" + {session_fixed_effects}"
independent_vars_list = [independent_vars1,independent_vars2,independent_vars3]
