...
for measure in ['count','mean']:
    ...
    ax.text(-0.1, 1.1, f"{title_label}", transform=ax.transAxes, fontsize=18, fontweight='bold', ha='left', va='top')
    ax.set_xlabel("")
...
independent_vars = "Sex + Age + Screen_Number + Session + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration" #+ ConfDuration
independent_vars = "Sex + Age + Screen_Number + Session + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration + Sex:Stringency_Index + Sex:Reported_Loneliness + Sex:Felt_Loneliness + Sex:Subjective_Confinement + Sex:ConfDuration" #+ ConfDuration
