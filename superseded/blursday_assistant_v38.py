...
independent_vars = "Sex + Age + Screen_Number + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration" #+ ConfDuration
independent_vars = "Sex + Age + Screen_Number + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration + Sex:Stringency_Index + Sex:Reported_Loneliness + Sex:Felt_Loneliness + Sex:Subjective_Confinement + Sex:ConfDuration"

# BFI-10 and Sex/BFI-10 Interactions
independent_vars = "Sex + Age + Screen_Number + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration + Extraversion + Agreeableness + Conscientiousness + Neuroticism + Openness"
independent_vars = "Sex + Age + Screen_Number + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration + Extraversion + Agreeableness + Conscientiousness + Neuroticism + Openness + Sex:Extraversion + Sex:Agreeableness + Sex:Conscientiousness + Sex:Neuroticism + Sex:Openness"

# ZTPI and Sex/ZTPI Interactions
independent_vars = "Sex + Age + Screen_Number + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration + PastNegative + PastPositive + PresentHedonistic + PresentFatalistic + Future"
independent_vars = "Sex + Age + Screen_Number + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration + PastNegative + PastPositive + PresentHedonistic + PresentFatalistic + Future+ Sex:PastNegative + Sex:PastPositive + Sex:PresentHedonistic + Sex:PresentFatalistic + Sex:Future"

# FFA (Mindfulness_Score) and Sex/FFA Interactions
independent_vars = "Sex + Age + Screen_Number + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration + Mindfulness_Score"
independent_vars = "Sex + Age + Screen_Number + Stringency_Index + Reported_Loneliness + Felt_Loneliness + Subjective_Confinement + ConfDuration + Mindfulness_Score + Sex:Mindfulness_Score"
...
independent_vars += f" + {session_fixed_effects}"
